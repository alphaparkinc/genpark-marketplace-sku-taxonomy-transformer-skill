# genpark-marketplace-sku-taxonomy-transformer-skill
...
**genpark-marketplace-sku-taxonomy-transformer-skill** is a deterministic, zero-dependency Python skill engineered for multi-channel product catalog syndication, pricing compliance, and cross-border duties.

> **Executive Capability**: Multi-marketplace SKU taxonomy transformer & feed validator (ChannelEngine)
...
result = client.transform_sku_attributes()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-marketplace-sku-taxonomy-transformer-skill": {
      "command": "python",
      "args": ["/path/to/genpark-marketplace-sku-taxonomy-transformer-skill/mcp_server.py"]
    }
  }
}
```
